...
class View extends \Kotchasan\KBase
{
    ...
    public function index()
    {
        ...
        $data2 .= 'header.header,body.loginpage,.language-menu li>a:hover,.topmenu>ul ul>li.hover>a,.gdpanel a:hover{background-color:'.self::$cfg->bg_color.'}';
        $data2 .= 'header.header .td,.topmenu>ul>li,.language-menu li>a:hover,.topmenu>ul ul>li.hover>a,.gdpanel a:hover{color:'.self::$cfg->color.'}';
